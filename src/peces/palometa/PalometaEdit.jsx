...
const PalometaEdit = () => {
    ...
    if (updatedData) {
      try {
        ...
        if (response.ok) {
          ...
          setpalometaData(prevData => prevData.map(item => 
  ...
  const getColumnNames = () => {
    if (palometaData.length > 0) {
      const allKeys = new Set();
      palometaData.forEach(item => {
  ...
  return (
    <div className={styles.palometaEditContainer}>
      ...
      <div className={styles.tableContainer}>
        <table className={styles.palometaEditTable}>
          <thead>
            <tr>
