    ...
    <div className={styles.palometaContainer}>
      ...
      <div className={styles.palometaContent}>
        ...
        <div className={styles.palometaButtonContainer}>
          <button className={styles.palometaButton} onClick={() => handleSelectPez('palometa', '/palometa-food')}>
            Alimentar
          </button>
          {canEditPeces && (
            <button className={styles.palometaButton} onClick={() => handleSelectPez('palometa', '/palometa-edit')}>
              Editar datos
            </button>
          )}
        </div>
