...
const CojinovaEdit = () => {
    ...
    if (updatedData) {
      try {
        ...
        if (response.ok) {
          ...
          setcojinovaData(prevData => prevData.map(item => 
  ...
  const getColumnNames = () => {
    if (cojinovaData.length > 0) {
      const allKeys = new Set();
      cojinovaData.forEach(item => {
  ...
  return (
    <div className={styles.cojinovaEditContainer}>
      ...
      <div className={styles.tableContainer}>
        <table className={styles.cojinovaEditTable}>
          <thead>
            <tr>
